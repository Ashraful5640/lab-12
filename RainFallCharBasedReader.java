...
public class RainFallCharBasedReader {
	...
	public static void main (String [] args)
	{
		...
		String sourceFile = "RainfallCharBased.txt";//c
		...
		try
		{
			...
			// 3. Read the data
			dailyRainfall = brInput.readLine();//metthid
